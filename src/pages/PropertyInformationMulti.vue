    ...
    <div class="nav-type">
      ...
      <div>
        <router-link to="/sign-up">
          <button class="nav-btn-sign-up sign-up-btn">Log out</button>
        </router-link>
      </div>
    </div>
    <div class="for-flex">
      <div class="log-box-div">
          ...
          <div class="two-label">
            ...
            <label class="lable-inp gap">
              ...
              <select name="cars" id="cars" class="box-aligment">
                ...
                <option value="saab">Multiplex</option>
                <option value="opel">Single-Family</option>
                <option value="saab">Townhouse</option>
                <option value="saab">Condo</option>
                <option value="saab">Commercial</option>
              </select>
            </label>
          </div>
        ...
        <div class="btn-log-div">
          <button v-on:click="signUpUser" class="btn-log">Next</button>
        </div>
      </div>
    </div>
  </div>
